                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                durante el inicio de sesión, que puedes obtener
                                de la aplicación compatible con TOTP en tu
                                teléfono.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                factores, se te solicitará un PIN seguro durante
                                el inicio de sesión. Este PIN se puede obtener
                                de una aplicación compatible con TOTP en tu
                                teléfono.
                            </p>

...
type SidebarContext = {
  ...
  isMobile: boolean
  toggleSidebar: () => void
  toggleSidebarBySide: (side: "left" | "right") => void
}
...
function SidebarProvider({
  ...
  const toggleSidebarBySide = React.useCallback((side: "left" | "right") => {
    if (side === "left") {
  ...
  }, [setOpenMobileLeft, setOpenMobileRight])
  ...
  const contextValue = React.useMemo<SidebarContext>(
    ...
    [state, open, setOpen, isMobile, openMobileLeft, setOpenMobileLeft, openMobileRight, setOpenMobileRight, toggleSidebar, toggleSidebarBySide]
  )
...
function Sidebar({
  ...
  const { isMobile, state, openMobileLeft, setOpenMobileLeft, openMobileRight, setOpenMobileRight } = useSidebar()
...
function SidebarTrigger({
  ...
  const { toggleSidebarBySide, toggleSidebar, isMobile, state, openMobileLeft, openMobileRight } = useSidebar()

  const isOpen = isMobile 
    ? (side === "left" ? openMobileLeft : openMobileRight)
    : state === "expanded"
